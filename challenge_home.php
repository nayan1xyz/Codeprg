...
<div class="container challenge_nav">
  <ul class="nav">
    <li class="nav-item">
      <a class="nav-link challenge_sub_nav challenges" href="challenge_home.php">Challenges</a>
    </li>
    <li class="nav-item">
      <a class="nav-link challenge_sub_nav" href="quiz_display.php">Quizes</a>
    </li>
    <li class="nav-item">
      <a class="nav-link challenge_sub_nav" href="custom_challenge.php">Customs</a>
    </li>
  </ul>
</div>

	<div class="container challenge_main mt-5">
		<h4 style="color:#000; font-weight: 600; margin-top: 16px;">Recently Added</h4>
	<div class="container inner">	
	<div class="media position-relative">

		<img class="mr-2" style="height: 144px; width: 144px" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSxHrRAV15mYCXkZjGvSkZpqZwWe5uIKeMynw&usqp=CAU"
		alt="image">

		<div class="media-body">
		<h5 class="mt-0" style="font-weight: 800;">CODE JAM</h5>
		<p style="font-weight: 400;">Google Code Jam is an international programming competition hosted and administered by Google. The competition began in 2003. The competition consists of a set of algorithmic problems which must be solved in a fixed amount of time.</p>
		<a href="https://codingcompetitions.withgoogle.com/codejam" class="stretched-link">Register Now</a>
		</div>
		</div>
		...
		<div class="media-body">
		<h5 class="mt-0" style="font-weight: 800;">CODE VITA</h5>
		<p>TCS CodeVita, is a contest for engineering and science students to experience the joy of coding and to sharpen their programming skills through real-life computing practices.</p>
		<a href="https://www.tcscodevita.com/" class="stretched-link">Register Now</a>
		</div>
		</div>
		...
		<div class="media-body">
		<h5 class="mt-0" style="font-weight: 800;">IMAGINE CUP</h5>
		<p>Make an impact through coding, collaboration, and competition. Innovate with passion to tackle global issues and bring your tech solution to life in the Imagine Cup. </p>
		<a href="https://imaginecup.microsoft.com/en-us/Events?id=0" class="stretched-link">Register Now</a>
		</div>
		</div>
