...
$user=$_SESSION['username'];
	...
	if(isset($_POST['number']))
	{
		...
		{
			$sqli = "INSERT INTO custom_quiz (username, meeting_id, meeting_password, name_of_contest, date, start, end, question, option1, option2, option3, option4, answer) VALUES ('$user', '$ID', '$PASSWORD', '".$_POST['name']."', '".$_POST['date']."', '".$_POST['start']."', '".$_POST['end']."', '".$_POST['question'][$i]."', '".$_POST['option1'][$i]."', '".$_POST['option2'][$i]."', '".$_POST['option3'][$i]."', '".$_POST['option4'][$i]."', '".$_POST['answer'][$i]."')";
			$result=mysqli_query($conn, $sqli);
		}
	}
	else
	{
		header("Location: custom_basic_form2.php")  ;
		exit;
	}
?>
            ...
            <div class="container content">
                    <div class="quizdiv">
                        ...
                        <div class="quiz-inner">
                            <h1>Quiz Scheduled</h1>
                        </div>
                        
                        <div class="quiz-exinner">
                            <p>This is your <strong>TEST ID </strong>and <strong>TEST PASSWORD </strong></p>
                        </div>
						...
						<div class="quiz-ininner">
							<p><strong>Note: Please read it carefully and follow each step.<strong></p>
							<p>1. Please note the TEST ID and PASSWORD you can share it before 10 minutes when the test starts.</p>
							<p>2. When you make a test it will be online and it will start at the time you have given and end at the time too.</p>
							<p>3. You can also <a href="#">click here</a> and download ID, PASSWORD, site link for students.</p>
							<p>4. The site link can be shared with students because ID and PASSWORD are the same for all.</p>
							<p>5. The students can join the test by going to</p>
							<p>For Students<p>
							<p>First login/signup to CODEprg.com > HOME > CHALLENGES > QUIZ > then search for Contest to JOIN.</p>
