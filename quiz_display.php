...
<!--main content -->
	...
	<h4 style="color:#000; font-weight: 600; margin-top: 10px;">Recently Added</h4>
	...
	<?php
		include 'dbconnection.php';
			...
			$sql1="SELECT *, COUNT( name_of_contest ) x FROM custom_quiz GROUP BY name_of_contest HAVING x >0 ";
		...
		?>
			<div class="media position-relative">
				...
				<img class="mr-2 IMG" style="height: 144px; width: 144px" src="quiz1.png" alt="image">

				<div class="media-body">
				<h5 class="mt-0"><?php echo $contest ?></h5>
				<p>Start at : <?php echo $start?></p>
				<p>End at : <?php echo $end?></p>
				<p>Date : October <?php echo $date?> 2020</p>

				<a href="quiz_login.php?error=0" style="text-decoration: none;" class="stretched-link">Status : In Progress</a>
				</div>
			</div>
