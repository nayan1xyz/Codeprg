...
<?php
			...
			<div class="dropdownmenu">
				...
				<button class="dropbtn" style="padding: 8px;"> '.$user.' </button>
					<div class="dropdown-content" id="navbarNav";">
						<a class="nav-item nav-link" href="profile.php?link='.$user.'">Profile</a>
    ...
    echo '
    <div class="poLhy">
        <div class="hiweo d-inline">
            <img width="40px" heigt="40px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/PICA.jpg/600px-PICA.jpg" alt="defaltimg">
            <p>'. $user.'<p>
        </div>
        <div class="pofgd">
            <div class="whtus">
            ...
            echo '
            <p><a class="pag" href="profile.php?link='.$user.'">Profile</a><p>
            </div>
            <div class="whtus">
            <p><a class="pag" href="edit_profile.php">Edit Profile</a></p>
            </div>
            <div class="whtus">
            <p><a class="pag" href="logout.php">Logout</a></p>
            </div>';
    }
    else{
        echo 'pls login to continue';
            ...
            ?>
            <?php if($user=="Admin"){
                        echo '<div class="whtus">
                        <a class="pag" href="adminDash.php">Dashboard</a></div>';
					} ?>
