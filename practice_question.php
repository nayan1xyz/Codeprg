...
<!--sub navbar -->
	...
	<ul class="nav">
		<li class="nav-item">
		<a class="nav-link challenge_sub_nav" href="#"></a>
		</li>
		<li class="nav-item">
		<a class="nav-link challenge_sub_nav" href="#"></a>
		</li>
	...
	<div class="container emp-profile">
        <div class="tab-content profile-tab" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">  
                <div class="row">
					<div class="col-9">
						<div class="container prob bg-light mb-5">
							<?php
                                include 'dbconnection.php';

                                $dd = $_GET['title'];
                                $sql = "SELECT * FROM `prac_problem` WHERE name='$dd';";
                            ...
                            ?>
                            <h4 class="text-center text-uppercase pt-3 mt-5">TITLE: <?php echo $dd;?></h4>

                            <h5 class="text-xl-left p-3 m-1">Problem</h5>
                            <div class="container ">
                                <p>
                                    <?php echo $desc;?>
                                </p>
                            </div>
                            <h5 class="text-xl-left p-3 m-1">Input Format</h5>
                            <div class="container ">
                                <p>
                                    <?php echo $iformat;?>
                                </p>
                            </div>
                            <h5 class="text-xl-left p-3 m-1">Output Format</h5>
                            <div class="container ">
                                <p>
                                    <?php echo $oformat;?>
                                </p>
                            </div>
                            <h5 class="text-xl-left p-3 m-1">Constraints</h5>
                            <div class="container ">
                                <p>
                                    <?php echo $constraints;?>
                                </p>
                            </div>
                            <h5 class="text-xl-left p-3 m-1">Sample Input</h5>
                            <div class="container ">
                                <p>
                                    <?php echo $si;?>
                                </p>
                            </div>
                            <h5 class="text-xl-left p-3 m-1">Sample Output</h5>
        ...
        <a class="btn btn-primary m-5 lg-only" href="compilr.php?title=<?php echo $name;?>" role="button">Practice here</a>
    </div>
