...
<div class="container plan">
	...
	<p>100 student participation, time : unlimited </p>
	<p><button onclick="window.location.href='Basic_plan.php';">Continue</button></p>
	</div>
	...
	<p>100 student participation, time : unlimited , question library</p>
	<p><button onclick="window.location.href='#';">Continue</button></p>
	</div>
	...
	<h1>PREMIUM</h1>
	<p class="price">------</p>
	<p>Fully custom challenge <strong><br>(For company, institutes)</strong></p>
	<p><button onclick="window.location.href='#';">Continue</button></p>
	</div>
