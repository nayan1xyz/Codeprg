...
<div class="container challenge_nav">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link challenge_sub_nav" href="quiz_display.php">Quizes</a>
    </li>
    <li class="nav-item">
    ...
    <div class="container plan">
        <div class="flex-container">
            <div class="container content">
                ...
                <h5>Price</h5>
                    <p>This plan is free of cost.</p>
                <h5>Process</h5>
                    <p>Let us just take you through the process of hosting your contest on Codeprg.</p>
                <ul>
                    <li>Firstly, you will have to fill this <a href="custom_basic_form2.php?error=4"><b>FORM</b>.</a></li>
                    <li>You have to upload your questions and answer on the page and click next you will get test id and password once you downloaded the id, password click <b>INSERT<b>.</li>
                    <li>Codeprg will automatically create the quiz. you can find the quiz here CHALLENGES --> <a href="quiz_display.php"><b>QUIZES</b></a>.</li>
                    <li>Once you are done with uploading the questions, you will get an <b>QUIZ ADMIN PANEL</b> on dashboard where you can manage the quiz.</li>
                    <li><b>MANAGE --></b> you will get participants information and scores. you can also start and end the contest</li>
                    <li>We hope this information is helpfull to you.</li>
                    
                </ul>
                <h5>Detail</h5>
                    <p>Note: </p>
                <ul>
                    <li>There can be only 100 participants that can take quiz.</li>
                    <li>This quiz can be taken at any time and place.</li>
                    <li>You can share the link to the participants to take quiz.</li>
...
<!--
        <div class="flex-container">
            <div class="container content">
                ...
                <h5>Price</h5>
                    <p>This plan cost is 100rs.</p>
                <h5>Process</h5>
                    <p>Let us just take you through the process of hosting your contest on Codeprg.</p>
                <ul>
                    <li>Firstly, you will have to fill this <a href="custom_basic_form2.php?error=4">form.</a></li>
                    <li>You have to upload your questions on the page.</li>
                    <li>Codeprg will verify your application and grant you access to upload problems along with a test contest page.</li>
                    <li>Once you are done with uploading the problem to the test contest page, you need to submit a successful submission to that problem (fix the bug in test data/ time-limit, if any). After you are done with this, write an editorial for your problems (which you will have to upload on our discussion forum after the contest ends) and email it to us (ideally 3-4 days before your main contest)</li>
                    <li>After this, we will be creating the main contest page for you and sending it to you along with the manage access for your contest.</li>
                    <li>The list of all sponsors for your contest must be given to CodeChef well in advance for approval.</li>
                    <li></li>
        ...
        <div class="flex-container">
            <div class="container content">
                ...
                <h5>Price</h5>
                    <p>This plan cost is deside as per consult.</p>
                <h5>Process</h5>
                    <p>Let us just take you through the process of hosting your contest on Codeprg.</p>
                <ul>
                    <li>Firstly, you will have to fill this <a href="custom_basic_form2.php?error=4">form.</a></li>
