...
?>
    <link rel="stylesheet" href="register_for_contest.css">
</head>
<body>
    <?php
...
'     <div class="main mt-5">';
        ...
        echo '
         <div class="from col-md-6 col-sm-12">
         ';
           if($status=="success"){
               
            echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                  <strong>Success!</strong> Your request has been successfully submitted. It will shown after Admins Approval.<br>THANKYOU!!
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>';
           }
        echo ' <div class="login-form mt-5">
               <form method="post" action="config_sql_\RequestingforCourse.php">
                  <div class="form-group mt-5">
                     <label>Author Name</label>
                     <input type="text" class="form-control" name="authorname" placeholder="@Author Name" required>
                  </div>
                  <div class="form-group">
                     <label>Author mobile no.</label>
                     <input type="text" class="form-control" name="mbno" placeholder="Author no." required>
                  </div>
                  <div class="form-group">
                     <label>Starting Date</label>
                     <input type="date" class="form-control" name="stdate" placeholder="Course begins from"required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     <label>Price</label>
                     <input type="text" class="form-control" name="price" placeholder="$Price for the course" required>
                  </div>
                  <button type="submit" class="btn btn-black mb-4">Register</button>
         ...
         <div class="container">
           <h1 class="display-4">Please login to Register</h1>
           <p class="lead">To continue : <a href="login.php"><button class="btn btn-info">Click Here</button></a> </p>
         </div>
       </div>';
