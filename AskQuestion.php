		...
		<div class="VfdSE XiOhy">
			<div class="gytdq">
				<form class="form-inline sea my-2 my-lg-0" action="search.php" method="POST">
					<div class="FgraZ">
						<div class="CtyUo">
							<input class="form-control search form-control-primary ds-input" name="search" type="search" placeholder="Search" aria-label="Search"  dir="auto">
						</div>
					</div>
				</form>
			</div>
...
<div class="container challenge_nav">
  <ul class="nav">
    ...
    <li><form class="form-inline my-2 my-lg-0 " method="POST" action="config_sql_\searchquestion.php">
    <input class="form-control" type="search" name="search" placeholder="Search by keywords" aria-label="Search">
...
<center>
  ...
  <strong>Success!</strong> Your Question has been successfully posted after Admins Approval.<br>
  Please check after sometime<br>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    ?>
<button class="btn btn-outline-dark m-3 mt-3" onclick="myFunction()">Ask Question</button>
</center>
<div id="myDIV">
    <!-- <div class="container"> -->
    <?php
    ...
    <div class="container">
    <h1 class="display-4">Question related to '.$thname.' </h1>
    </div>
    </div>';
    if(isset($_SESSION['username'])){
    echo '<div class="container">
        <h1 class="lead">Ask your question..</h1>
        <form method="POST" action="config_sql_\insertquestion.php?link='.$thname.'">
            ...
            <div class="form-row">
                <div class="form-group col-md-2">
                    <label for="Keyword">Keyword1</label>
                    <input type="text" name="keyword1" class="form-control" required>
                </div>
                <div class="form-group col-md-2">
                <label for="Keyword">Keyword2</label>
                    <input type="text" name="keyword2" class="form-control" required> 
                </div>
                <div class="form-group col-md-2">
                    <label for="Keyword">Keyword3</label>
                    <input type="text" name="keyword3" class="form-control" required>
                </div>
            </div>
        ...
        echo '<div class="container">
        <h1 class="lead">Ask your question..</h1>
        <h1 class="lead">Please login to post a question , then you can able to post & see asked question ..</h1>';
    }
}
    ?>
</div>    
...
function myFunction() {
  ...
  if (x.style.visibility === "visible") {
    ...
    <hr class="col-md-3" color="black">
    <?php
     
        

    if((isset($_GET['link']))&&$_GET['link']!=''){
    $sql_fetch="SELECT * FROM `question_asked` WHERE `categories`='$thname'  AND `isapprove`='1'";
    $result_fetch=mysqli_query($conn,$sql_fetch);
    $num=mysqli_num_rows($result_fetch);
    if($num>0){
    while($row=mysqli_fetch_assoc($result_fetch)){
        ...
        <a href="comments.php?link='.$ques_title.'&status=0" class="text-decoration-none anke">
        <h3 >'.$ques_title.'</h3>
       
      
    <div class="row-fluid text-justify d-block container">
    
        </div>
        </a>
        <div class="text-right"><em>Posted by - <b>'.$posted_user.' at '.$posted_date.'</b></em></div>
      ...
      <hr style="color: gray;">';
        ...
        <a class="btn btn-primary btn-lg" href="community_home.php?status=0" role="button">Get here</a>
      </div>';
     }
