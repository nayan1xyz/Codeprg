...
<div class="container challenge_nav">
  <ul class="nav">    
    <li class="nav-item">
		<input class="form-control ds-input" name="search" type="search" placeholder="Search for Courses" aria-label="Search" dir="auto">
    </li>
	<li class="nav-item">
      <a class="nav-link challenge_sub_nav" href="#">Fliters</a>
    </li>
  </ul>
</div>

<div class="container challenge_main">
	<?php
	 
	 include 'dbconnection.php';

    
		$sql_fetch="SELECT * FROM `registercontesthere` WHERE `isapprove`='1'";
		...
		while($row=mysqli_fetch_assoc($result_fetch)){
			...
			<div class="md-8">
			 ...
			 <iframe src="'.$vdurl.'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			
			</div>
			<div class="md-4">
			<div class="text-center ml-3 mt-3">
			<div class="container text-center">
			<h4>Author Name :'.$author.'</h4>
			<h5>Starting Date :'.$stdate.'</h5>
			<h5>Introduction url :<a href="'.$vdurl.'">Get Here</a></h5>
			<h5>Course Price :Rs. '.$cprice.'</h5>
			</div>
			</div>
			...
			<a class="btn btn-primary btn-lg" href="register_for_contest.php?status=0" role="button">Get here</a>
		  </div>';
		 }
