...
$sql="SELECT * FROM `quiz_admin` WHERE username = '$uname';";
			...
			<div class="dropdownmenu">
				...
				<button class="dropbtn" style="padding: 8px;"> '.$user.' </button>
					<div class="dropdown-content" id="navbarNav";">
						...
						<a class="nav-item nav-link" onclick="gofunction()" href="edit_profile.php">Edit Profile</a>
							 ';
						 if($user=="Admin"){
...
<div class="container challenge_nav">
    <div class="row">
        <div class="col-6 text-right"><a href="StartQuizsql.php" class="btn btn-info btn-sm">Start The Quiz</a></div>
    
        <div class="col-6 "><a href="EndQuizsql.php" class="btn btn-danger btn-sm">End The Quiz</a></div>
    </div>
</div>
<?php echo "<p>".$mess."</p>";?>
<div class="container">
<div class=""><a href="downloadQuiz.php" class="btn btn-success btn-sm">Download Participants Data</a></div>
</div>
...
<div class="container challenge_navs">
  <ul class="nav">
    <li class="nav-item">
